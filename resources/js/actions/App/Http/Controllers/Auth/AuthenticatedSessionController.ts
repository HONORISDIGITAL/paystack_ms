...
/**
* @see \App\Http\Controllers\Auth\AuthenticatedSessionController::apiLogin
...
/**
* @see \App\Http\Controllers\Auth\AuthenticatedSessionController::apiDestroy
* @see app/Http/Controllers/Auth/AuthenticatedSessionController.php:85
* @route '/api/logout'
*/
export const apiDestroy = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/api/logout'
*/
apiDestroy.post = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: apiDestroy.url(options),
    method: 'post',
})
...
* @route '/api/logout'
*/
const apiDestroyForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: apiDestroy.url(options),
    method: 'post',
})
...
* @route '/api/logout'
*/
apiDestroyForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: apiDestroy.url(options),
    method: 'post',
})
...
const AuthenticatedSessionController = { apiLogin, apiDestroy, create, store, destroy }
